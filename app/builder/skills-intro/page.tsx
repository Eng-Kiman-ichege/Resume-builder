        ...
        <div className="w-full lg:w-1/2 xl:w-7/12 flex flex-col h-full justify-center px-8 md:px-16 lg:px-24 py-12 relative z-10">
          ...
          >
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 max-w-lg leading-relaxed">
              *Most companies use ATS (applicant tracking system) to scan your resume based on keywords. Beat this ATS scan and get your resume in the hands of a recruiter.
            </p>
          </motion.div>
              ...
              <div className="flex-1 text-[8px] leading-tight flex flex-col gap-4">
                ...
                <div className="relative mt-2">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-1 text-slate-500 gap-2 font-medium">
                      <div className="opacity-40">Skill 1</div>
                      <div className="opacity-40">Skill 2</div>
                      <div className="opacity-40">Skill 3</div>
                      <div className="opacity-40">Skill 4</div>
                    </div>
                  </div>
                </div>
